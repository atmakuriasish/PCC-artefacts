...
parse_promotions() {
  ...
  do
    ...
    then
      echo "python3 get_promotions.py output/single_thread/${type}/${dir}/${filename} $footprint"
      python3 get_promotions.py output/single_thread/${type}/${dir}/${filename} $footprint
    fi
  done
}
...
parse_demotions() {
  ...
  then
    echo "python3 get_demotions.py output/single_thread/${type}/${app}/${filename}"
    python3 get_demotions.py output/single_thread/${type}/${app}/${filename}
  fi
}
...
parse_promotions_mt() {
  ...
  do
    ...
    then
      echo "python3 get_promotions_mt.py output/multithread/${type}/${dir}/${filename} $threads $footprint $policy"
      python3 get_promotions_mt.py output/multithread/${type}/${dir}/${filename} $threads $footprint $policy
    fi
  done
}
